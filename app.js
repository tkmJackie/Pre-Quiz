...
async function renderApp() {
  ...
  $("adminView").classList.toggle("hidden", isContact || session.role !== "admin");
  $("companyView").classList.toggle("hidden", isContact || session.role !== "company_manager");
  $("studentView").classList.toggle("hidden", isContact || session.role !== "student");
